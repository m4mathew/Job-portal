    ...
    describe('Applicant Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/applicants';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Applicant', () => {
                service.create(new Applicant(null)).subscribe(received => {
            ...
            it('should update a Applicant', () => {
                service.update(new Applicant(123)).subscribe(received => {
